...
public final class ExcludedRefs implements Serializable {
    ...
    private ExcludedRefs(Map<String, Map<String, Boolean>> fieldNameByClassName,
        ...
        // Copy + unmodifiable.
        this.fieldNameByClassName = unmodifiableMap(new LinkedHashMap<String, Map<String, Boolean>>(fieldNameByClassName));
        this.staticFieldNameByClassName =
                unmodifiableMap(new LinkedHashMap<String, Map<String, Boolean>>(staticFieldNameByClassName));
        this.threadNames = unmodifiableMap(new LinkedHashMap<String, Boolean>(threadNames));
        this.classNames = unmodifiableMap(new LinkedHashMap<String, Boolean>(classNames));
    }
    ...
    public static final class Builder {
        private final Map<String, Map<String, Boolean>> fieldNameByClassName = new LinkedHashMap<String, Map<String, Boolean>>();
        private final Map<String, Map<String, Boolean>> staticFieldNameByClassName =
                new LinkedHashMap<String, Map<String, Boolean>>();
        private final Map<String, Boolean> threadNames = new LinkedHashMap<String, Boolean>();
        private final Map<String, Boolean> classNames = new LinkedHashMap<String, Boolean>();
        ...
        public Builder instanceField(String className, String fieldName, boolean always) {
            ...
            if (excludedFields == null) {
                excludedFields = new LinkedHashMap<String, Boolean>();
